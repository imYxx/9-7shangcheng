...
<body>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			...
			<div class="cart fl">
				<dl>
					<dt>
						<a href="<?=\yii\helpers\Url::to('show-cart')?>">去购物车结算</a>
						<b></b>
					</dt>
					<dd>
						<div class="prompt">
		...
		<div class="nav w1210 bc mt10">
			...
			<div class="navitems fl">
				<ul class="fl">
					<li class="current"><a href="<?=\yii\helpers\Url::to(['member/index'])?>">首页</a></li>
					<li><a href="">电脑频道</a></li>
					<li><a href="">家用电器</a></li>
					<li><a href="">品牌大全</a></li>
					<li><a href="">团购</a></li>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="http://www.yiishop.com/member/index">首页</a> >
                <a href=""><?=$goods_category1->name?></a> >
                <a href=""><?=$goods_category2->name?></a> >
                <?=$goods->name?></h2>
		</div>
		<!-- 面包屑导航 end -->
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						...
						<a href="<?=$goods_gallery['0']->path?>" class="jqzoom" rel="gal1">

							<img src="<?=$goods_gallery['0']->path?>" alt="" />
						</a>
					</div>
...
//									?><!-- 	-->
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有19872人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="comment detail_div mt10">
						...
						<!-- 分页信息 start -->
						<div class="page mt20">
							<a href="<?=\yii\helpers\Url::to(['member/index'])?>">首页</a>
							<a href="">上一页</a>
							<a href="">1</a>
