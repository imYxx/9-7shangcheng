...
<body>
                        ...
                        <div class="cat item1">
                            ...
                            <div class="cat_detail none">
                                <?php foreach ($model->children as $child):?>
                                    <dl class="dl_1st">
                                    <dt><a href="<?=\yii\helpers\Url::to(['goods/list','category_id'=>$child->id])?>"><?=$child->name?></a>
                                    </dt>
                                    <dd>
	...
	<div class="list w1210 bc mt10">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="http://www.yiishop.com/member/index">首页</a> > <a href="">电脑、办公</a></h2>
		</div>
		<!-- 面包屑导航 end -->
                ...
                <ul>
                    <li>
                        <dl>
                            ...
                            <dd><a href="/goods/goods?id=<?=$good->id?>"><?=$good->name?></a></dt>
