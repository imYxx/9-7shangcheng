...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            <h3>收货地址薄</h3>
            <?php foreach(\frontend\models\Address::getAddress() as $addres):?>
                <?php
                //var_dump($addres);exit;
                ?>

            <dl >
                <dt><?=$addres->name?>   <?=$addres->province.$addres->city.$addres->area.$addres->address?>  <?=$addres->tel?></dt>
                <dd>
                    <a href="<?=\yii\helpers\Url::to(['member/edit','id'=>$addres->id])?>">编辑</a>
                    <a href="<?=\yii\helpers\Url::to(['member/del','id'=>$addres->id])?>">删除</a>
                    <a href="">设为默认地址</a>
                </dd>
            </dl>
            <?php endforeach;?>
            ...
            <form action="<?=\yii\helpers\Url::to(['member/address'])?>" method="post" name="address_form">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" name="location_b" class="txt address" id="address" />
                    </li>
                    <li>
